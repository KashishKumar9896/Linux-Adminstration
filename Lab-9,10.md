...
#### Screenshots:
- ![Display processes for the current user](screenshot/10.png)
- ![Display all processes](screenshot/10.png)
- ![Display processes in full format](screenshot/10.png)
...
#### Screenshot:
![Running top command](screenshot/11.png)
...
#### Screenshots:
- ![Terminating a process by PID](screenshot/12.png)
- ![Forcefully terminating a process](screenshot/13.png)
...
#### Screenshot:
![Installing htop](screenshot/14.png)
...
#### Screenshots:
- ![Updating package list](screenshot/15.png)
- ![Upgrading packages](screenshot/16.png)
...
#### Screenshots:
- ![Removing htop](screenshot/17.png)
- ![Purging htop](screenshot/18.png)
...
#### Screenshot:
![Verifying htop installation](screenshot/19.png)
