...
#### Screenshot:
![Creating the consultants directory](screenshot/7.png)
...
#### Screenshot:
![Adding write permission to the group](screenshot/7.png)
...
#### Screenshot:
![Setting permissions using the octal method](screenshot/8.png)
...
#### Screenshot:
![Verifying directory permissions](screenshot/8.png)
...
#### Screenshot:
![Changing and verifying umask](screenshot/9.png)
...
#### Screenshot:
![Confirming umask with new file and directory](screenshot/9.png)
